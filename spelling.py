# The code runs in 2 passes. In first pass wordnet synsets find out possible spelling mistakes.
# But synsets give a false positive on a lot of words because they do not have synonyms.
# In second pass Norvig's code for spelling correction is used to filter out words
# and only keep the words it thinks is incorrect.
